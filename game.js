...
const uiDict = {
  en: {
    ...
    "부대 선택": "Pick a unit",
    "내 부대를 하나 누르십시오. 이동할 수 있는 칸이 지도에 밝게 표시됩니다.": "Tap one of your units. The tiles it can reach light up on the map.",
    "부대 이동": "Move it",
    "밝게 표시된 칸을 누르면 그곳으로 이동합니다. 한 부대는 하루에 한 번만 움직일 수 있습니다.": "Tap one of the lit tiles and the unit goes there. Each unit moves once a day.",
    "공격": "Attack",
    "붉은 적 부대가 사거리 안에 들어오면 그 부대를 누르십시오. 누르는 즉시 사격합니다. 사거리 밖이면 아무 일도 일어나지 않습니다.": "Once a red unit is in range, tapping it is the attack. Out of range, tapping does nothing.",
    "턴 종료": "End the day",
    "「턴 종료」를 누르면 적이 움직이고 다음 날 아침이 됩니다. 이때 진행 상황이 자동으로 저장됩니다.": "Press End Turn: the enemy moves and the next morning comes. The game saves itself each time.",
    "보급품 사용": "Spend your supply",
    "화면 위쪽 「보급품」이 매일 들어옵니다. 「지휘」를 누르면 병력을 증원하거나 다리·보급창고를 지을 수 있습니다.": "Supply comes in every day — it is the figure at the top. Press Command to raise units, or to build bridges and depots.",
...
const coachSteps = [
  {
    id: "goal",
    title: "승리 조건",
    body: "화면 맨 위 노란 줄이 이번 작전의 목표입니다. 어느 지점을 며칠 동안 지켜야 하는지 적혀 있습니다.",
    target: () => document.querySelector("#missionBar"),
  },
  {
    id: "select",
    title: "부대 선택",
    body: "내 부대를 하나 누르십시오. 이동할 수 있는 칸이 지도에 밝게 표시됩니다.",
  ...
  },
  {
    id: "move",
    title: "부대 이동",
    body: "밝게 표시된 칸을 누르면 그곳으로 이동합니다. 한 부대는 하루에 한 번만 움직일 수 있습니다.",
    target: () => document.querySelector("#mapStage"),
  ...
  },
  {
    ...
    body: "붉은 적 부대가 사거리 안에 들어오면 그 부대를 누르십시오. 누르는 즉시 사격합니다. 사거리 밖이면 아무 일도 일어나지 않습니다.",
    target: () => document.querySelector("#mapStage"),
  },
  {
    id: "endTurn",
    title: "턴 종료",
    body: "「턴 종료」를 누르면 적이 움직이고 다음 날 아침이 됩니다. 이때 진행 상황이 자동으로 저장됩니다.",
  ...
  },
  {
    id: "supply",
    title: "보급품 사용",
    body: "화면 위쪽 「보급품」이 매일 들어옵니다. 「지휘」를 누르면 병력을 증원하거나 다리·보급창고를 지을 수 있습니다.",
